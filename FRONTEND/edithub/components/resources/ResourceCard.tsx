...
import { cn, getCategoryColor, formatFileSize, formatDate } from '@/lib/utils';
    ...
    >
      ...
      <div className="relative aspect-video bg-surface overflow-hidden">
        ...
        <div className="absolute top-3 left-3">
          <span className={cn('text-xs font-semibold px-2.5 py-1 rounded-full backdrop-blur-sm', getCategoryColor(resource.category))}>
            {resource.category}
          </span>
        </div>
      </div>
